...
export const useAppStore = defineStore('app', {
  state: () => ({
    properties: [
      ...
      { name: 'strength', image: strength, counter: 0 },
      { name: 'weak', image: weak, counter: 0 },
      { name: 'vulnerable', image: vulnerable, counter: 0 },
      { name: 'gold', image: gold, counter: 0 },
      { name: 'miracle', image: miracle, counter: 0 },
      { name: 'shiv', image: shiv, counter: 0 },
    ]
  }),
